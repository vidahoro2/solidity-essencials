// SPDX-License-Identifier: GPL-3.0
 ...
 contract platziProject{
     ...
     //No te  preocupes por esto,luego lo aprenderemos. El modifier permite cambiar el comportamiento de funciones, en este caso solo queria asegurarme que solo el creador del contrato pudiera mover el Goal
     modifier onlyOwner{
